...
const ParticlesView = (props: {
  ...
  const animate = () => {
    ...
    circles.current.forEach((circle: Circle, i: number) => {
      ...
      circle.y += circle.dy;
      circle.translateX +=
        (mouse.current.x / ((props.staticity ?? 50) / circle.magnetism) - circle.translateX) /
        (props.ease ?? 50);
      circle.translateY +=
        (mouse.current.y / ((props.staticity ?? 50) / circle.magnetism) - circle.translateY) /
        (props.ease ?? 50);
  ...
  return (
    <div className={props.className} ref={canvasContainerRef} aria-hidden="true">
