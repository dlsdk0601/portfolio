...
const Page = () => {
  const [id, setId] = useValueField("", " 아이디", (value) => {
    if (isBlank(value)) {
      return "필수";
    }
  });
  ...
  return (
    <div className="flex h-screen flex-wrap items-center justify-center">
      <div className="w-3/4 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark xl:w-1/2">
        <div className="w-full p-3 sm:p-12.5 xl:p-17.5">
          ...
          <form>
            <div className="mb-4">
              <label className="mb-2.5 block font-medium text-black dark:text-white">id</label>
