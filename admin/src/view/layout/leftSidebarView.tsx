        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Forms --> */}
              <SidebarLinkGroup isActive={pathname === "/forms" || pathname.includes("forms")}>
                {(handleClick, open) => {
                  return (
                    <>
                      {/* eslint-disable-next-line jsx-a11y/anchor-is-valid */}
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup isActive={pathname === "/ui" || pathname.includes("ui")}>
                {(handleClick, open) => {
                  return (
                    <>
                      {/* eslint-disable-next-line jsx-a11y/anchor-is-valid */}
              ...
              <SidebarLinkGroup isActive={pathname === "/auth" || pathname.includes("auth")}>
                {(handleClick, open) => {
                  return (
                    <>
                      {/* eslint-disable-next-line jsx-a11y/anchor-is-valid */}
...
const SidebarLinkGroup = (props: {
  ...
  return <li>{props.children(onClick, isOpen)}</li>;
};
